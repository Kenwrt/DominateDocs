...
public partial class LoanWizardGuarantorViewModel : ObservableObject
{
    ...
    public LoanWizardGuarantorViewModel(IMongoDatabaseRepo dbApp, ILogger<LoanWizardGuarantorViewModel> logger, UserSession userSession, IApplicationStateManager appState)
    {
        this.dbApp = dbApp;
        this.logger = logger;
