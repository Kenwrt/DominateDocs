...
public partial class LoanWizardServicerViewModel : ObservableObject
{
    [ObservableProperty]
    ...
    private readonly ILogger<LoanWizardServicerViewModel> logger;
    private IApplicationStateManager appState;

    public LoanWizardServicerViewModel(IMongoDatabaseRepo dbApp, ILogger<LoanWizardServicerViewModel> logger, UserSession userSession, IApplicationStateManager appState)
    {
        this.dbApp = dbApp;
        this.logger = logger;
