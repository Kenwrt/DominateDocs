...
public partial class LoanWizardTrustViewModel : ObservableObject
{
    [ObservableProperty]
    ...
    private readonly ILogger<LoanWizardTrustViewModel> logger;

    public LoanWizardTrustViewModel(IMongoDatabaseRepo dbApp, ILogger<LoanWizardTrustViewModel> logger, UserSession userSession, IApplicationStateManager appState)
    {
        this.dbApp = dbApp;
        this.logger = logger;
