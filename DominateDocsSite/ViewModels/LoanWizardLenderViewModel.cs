...
public partial class LoanWizardLenderViewModel : ObservableObject
{
    ...
    public LoanWizardLenderViewModel(IMongoDatabaseRepo dbApp, ILogger<LoanWizardLenderViewModel> logger, UserSession userSession, IApplicationStateManager appState)
    {
        this.dbApp = dbApp;
        this.logger = logger;
