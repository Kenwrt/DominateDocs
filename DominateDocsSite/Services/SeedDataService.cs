...
//        new()
//        {
//            Id = Guid.NewGuid(), EntityType = Entity.Types.Entity,
//            Name = "Sunrise Capital Partners, LLC",
//            Structure = Entity.Structures.LLC,
...
//        new()
//        {
//            Id = Guid.NewGuid(), EntityType = Entity.Types.Individual,
//            Name = "Marcus Rivera",
...
//    [
//        new() { Id = Guid.NewGuid(), EntityName = "FCI Lender Services", FullAddress = "8180 E Kaiser Blvd, Anaheim, CA 92808", ContactPhoneNumber = "(800) 931-2424" },
//        new() { Id = Guid.NewGuid(), EntityName = "Planet Financial Group", FullAddress = "321 N Clark St, Chicago, IL 60654", ContactPhoneNumber = "(312) 555-0190" }
//    ];
