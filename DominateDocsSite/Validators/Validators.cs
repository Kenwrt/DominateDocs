...
public class PartyValidator : AbstractValidator<Party>
{
    public PartyValidator()
    {
        ...
        When(x => x.EntityType == EntityType.Entity, () =>
        {
        ...
        When(x => x.EntityType == EntityType.Trust, () =>
        {
...
public class BrokerValidator : AbstractValidator<Broker>
{
    ...
    {
        RuleFor(x => x.Name).NotEmpty().WithMessage("Broker name is required");
        When(x => x.IsLicensed, () =>
        {
            RuleFor(x => x.LicenseState).NotEmpty().WithMessage("License state is required");
