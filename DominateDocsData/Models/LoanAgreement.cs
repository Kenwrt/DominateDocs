...
public class LoanAgreement
{
    ...
    [BsonRepresentation(BsonType.String)]
    [DataType(DataType.Text)]
    public DominateDocsData.Enums.Payment.FeesPaidToOptions FeesPaidToOption { get; set; } = DominateDocsData.Enums.Payment.FeesPaidToOptions.PaymentDefferedUntilAfterClosing;
