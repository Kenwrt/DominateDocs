using DominateDocsData.Models.Enums;
...
//    public PaymentSchedules RepaymentSchedule { get; set; } = RepaymentSchedule.Monthly;
...
public class ConstructionDetails
{
    ...
    public List<SigningAuthority> ContractorSignatories { get; set; } = [];

    public bool HasDesignPro { get; set; }
    public string DesignProName { get; set; } = string.Empty;
    public List<SigningAuthority> DesignProSignatories { get; set; } = [];
